...
public class BoardDAO {
	...
	private final String BOARD_INSERT = "insert into BOARD3 (title, writer, content) values (?,?,?)";
	private final String BOARD_UPDATE = "update BOARD3 set title=?, writer=?, content=? where seq=?";
